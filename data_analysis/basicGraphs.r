...
groupedGraphData <- read.csv("./data/out_GraphSlicesAll_LIFPNG_1750165532.csv") %>%
  ...
  summarise()
autosomalGraphData <- filter(groupedGraphData,Xlinked==0,Sterile==0 |Sterile=="F",PostCompetitionMutationTiming == 0) #TODO:PostCompetitionMutationTiming 0 or 1
...
svglite("figures/figure_2A3.svg", width = 5.8, height = 4.35)
plot(extinctionRate~GrowthRate,data=filter(dataSlice2d.GrowthRate1,GrowthRate!=gr1,GrowthRate!=gr2,GrowthRate!=gr3,2<GrowthRate*(1-mf^2)^mc),ylim=c(0,1),xlim=c(2,6),ylab="Extinction probability",xlab="Female reproductive output ",pch=19)
par(new=TRUE)
plot(extinctionRate~GrowthRate,data=filter(dataSlice2d.GrowthRate1,GrowthRate!=gr1,GrowthRate!=gr2,GrowthRate!=gr3,2<GrowthRate*(1-mf^2)^mc),ylim=c(0,1),xlim=c(2,6),ylab="Extinction probability",xlab="Female reproductive output ",pch=19)
par(new=TRUE)
...
svglite("figures/figure_2B3.svg", width = 5.8, height = 4.35)
...
# par(new=TRUE)
plot(extinctionRate~MutationFrequency,data=filter(dataSlice2d.MutationFrequency3,2>=gr3*(1-MutationFrequency^2)^mc),ylim=c(0,1),xlim=c(0,0.07),ylab="Extinction probability",xlab="Deleterious recessive frequency",col="#68c24f",pch=1)
par(new=TRUE)
...
svglite("figures/figure_2C3.svg", width = 5.8, height = 4.35)
...
svglite("figures/figure_2D3.svg", width = 5.8, height = 4.35)
...
par(new=TRUE)
plot(extinctionRate~MutationCount,data=filter(dataSlice2d.MutationCount3,2>=gr3*(1-mf^2)^MutationCount),ylim=c(0,1),xlim=c(0,400),ylab="Extinction probability",xlab="Deleterious loci count",col="#68c24f",pch=1)
par(new=TRUE)
