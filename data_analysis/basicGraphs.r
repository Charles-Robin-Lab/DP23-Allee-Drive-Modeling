...
plot(extinctionRate~GrowthRate,data=filter(dataSlice2d.GrowthRate1,GrowthRate!=gr1,GrowthRate!=gr2,GrowthRate!=gr3,2<GrowthRate*(1-mf^2)^mc),ylim=c(0,1),xlim=c(2,6),ylab="Proportion extinct",xlab=expression("Female reproductive output (" * b[f] * ")"),pch=19)
par(new=TRUE)
...
plot(extinctionRate~MutationFrequency,data=filter(dataSlice2d.MutationFrequency3,2>=gr3*(1-MutationFrequency^2)^mc),ylim=c(0,1),xlim=c(0,0.07),ylab="Proportion extinct",xlab=expression("Deleterious recessive frequency (" * q * ")"),col="#68c24f",pch=1)
par(new=TRUE)
...
plot(extinctionRate~Individuals,data=dataSlice2d.Individuals3,ylim=c(0,1),xlim=c(0,120),ylab="Proportion extinct",xlab="Founding population size (N(0))",col="#68c24f",pch=19)
par(new=TRUE)
...
par(new=TRUE)
plot(extinctionRate~MutationCount,data=filter(dataSlice2d.MutationCount3,2>=gr3*(1-mf^2)^MutationCount),ylim=c(0,1),xlim=c(0,400),ylab="Proportion extinct",xlab=expression("Deleterious loci count (" * l * ")"),col="#68c24f",pch=1)
par(new=TRUE)
