# A script to examine how extinction proportion of sterile vs lethal effect varies through parameter space
  # Exploratory analysis using boosted regression trees
  # response variable is the normalised difference in extinction proportion
...
# Summarise to give extinction proportion
d <- d %>%
    ...
    # calculate extinction proportion for each part of parameter space
